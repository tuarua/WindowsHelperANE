...
copy %pathtome%..\..\native_library\win\%projectName%\x64\Debug\%projectName%Lib.dll %AIR_PATH_64%%projectName%Lib.dll
copy %pathtome%..\..\native_library\win\%projectName%\x64\Debug\%projectName%Lib.pdb %AIR_PATH_64%%projectName%Lib.pdb
...
copy %pathtome%..\..\native_library\win\%projectName%\x64\Debug\FreSharpCore.dll %AIR_PATH_64%FreSharpCore.dll
copy %pathtome%..\..\native_library\win\%projectName%\x64\Debug\FreSharpCore.pdb %AIR_PATH_64%FreSharpCore.pdb
...
copy %pathtome%..\..\native_library\win\%projectName%\x64\Debug\FreSharp.dll %AIR_PATH_64%FreSharp.dll
copy %pathtome%..\..\native_library\win\%projectName%\x64\Debug\FreSharp.pdb %AIR_PATH_64%FreSharp.pdb
